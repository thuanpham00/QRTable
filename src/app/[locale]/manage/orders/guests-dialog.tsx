...
const getColumns = (t: (key: string) => string): ColumnDef<GuestItem>[] => [
  {
    accessorKey: "name",
    header: t("nameHeader"),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: () => <div>{t("createdAtHeader")}</div>,
    cell: ({ row }) => (
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline">{t("selectGuestButton")}</Button>
      </DialogTrigger>
